...
export default () => {
    ...
    return (
        <footer className="text-gray-500 bg-[#f5f5dc] px-4 py-5  md:px-8">
            <div className="gap-6 justify-between md:flex">
                <div className="flex-1">
                    <div className="max-w-xs">
                    <div className={style.brandslogo}><DiYii /></div> 
                <div className="text-xl text-[#0c6cfb]"><b >Finderkart</b></div>
                        <p className="leading-relaxed mt-2 text-[15px]">
                            Get Gadgets Online at Best Price in India. Find best deals on Gadgets, Mobile Phones, Tablets, Laptops and many more.
                        </p>
                    </div>
                    <form 
            ...
            <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; 2023 Finderkart @ All rights reserved.
                </div>
                <div className="mt-6 sm:mt-0">
                    <ul className="flex items-center space-x-4">
                        <li className="w-10 h-10 border rounded-full flex items-center justify-center">
                            <a href="http://www.twitter.com/jathinsanjay">
                        ...
                        <li className="w-10 h-10 border rounded-full flex items-center justify-center">
                            <a href="http://www.instagram.com/jathinsanjay">
